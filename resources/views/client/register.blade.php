    ...
    <div class="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                <form class="space-y-6" action="{{ route('account.register') }}" method="POST">
                    @csrf
                    <div>
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input id="prenom" name="prenom" type="text" value="{{ old('nom') }}" required
                                class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            @error('prenom')
                                <div class="text-sm text-red-500 mt-1">
                                    {{ $message }}
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-sm">
                            <a href="{{ route('account.login') }}" class="font-medium text-indigo-600 hover:text-indigo-500"> Already have an
                                account ? </a>
                        </div>
                    </div>
